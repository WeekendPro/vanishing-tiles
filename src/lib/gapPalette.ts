...
// Seven maximally-distinct hues for color-coded rounds. The goal is recall, not
// trickery — so adjacent families (red/orange) are split across lightness TIERS
// (500 vs 400) as well as hue, and the old indigo (a near-twin of blue) is
// replaced by cyan to open up the cool end of the wheel. Keep BORDER and FILL on
// the same tier per id so a gap's dashed outline matches its filled piece.
